...
public enum EventKey
{
    ...
    enemyDamage,
    gameObjectDisabled,
    localDamageColliderContact,
    globalDamageColliderContact,
    destructibleDamageColliderContact,
    novoHeroiSpawnado,
    createdRoomInNetMultiplayerMenu,
    clickedInAdvanceToCreateNetGame,
    cancelRoomCreation,
    joinedRoom,
    kickPlayerButtonClicked,
    cancelWithplayerInRoom,
    cancelInInputRoomName,
    submitRoomName,
    buttonOwnerNameClicked,
    submitNameFronRoom,
    postCreatedRoom,
    joinRoomButtonClicked,
    cancelLocalPlayerInGame,
    UiDeOpcoesChange,
    positiveUiInput,
    negativeUiInput,
    listaDeJogadoresAtualizada,
    enemyDefeated,
    enemyDisable,
    addEnemyInManager,
    lanEnemyDefeated,
    ...
    startRefinedAttack,
    endRefinedAttack,
    startControlledMovement,
    externalMovementPositionOk,
    heroHealth,
    finallyTalk,
    finallyPresentation,
    finallyBosswalk,
    bossSpecialAttackStart,
    psicoCircleCharacterHit,
    endSpecialAttack,
    morteDoPlayer,
    retornaDaMortePlayer,
    initRoll,
    stopMovementForEndBoss
}